...
module "falco_dev_s3_role" {
  ...
  create  = true
  subjects = [
    "khulnasoft/falco:ref:refs/heads/master",
    "khulnasoft/falco:ref:refs/tags/*"
  ]
  policies = {
...
module "falcosidekick_ecr_role" {
  ...
  create  = true
  subjects = [
    "khulnasoft/falcosidekick:ref:refs/heads/master",
    "khulnasoft/falcosidekick:ref:refs/tags/*"
  ]
  policies = {
...
module "falcosidekick_ui_ecr_role" {
  ...
  create  = true
  subjects = [
    "khulnasoft/falcosidekick-ui:ref:refs/heads/master",
    "khulnasoft/falcosidekick-ui:ref:refs/tags/*"
  ]
  policies = {
...
module "falcoctl_ecr_role" {
  ...
  create  = true
  subjects = [
    "khulnasoft/falcoctl:ref:refs/heads/main",
    "khulnasoft/falcoctl:ref:refs/tags/*"
  ]
  policies = {
...
module "falco_playground_s3_role" {
  ...
  create  = true
  subjects = [
    "khulnasoft/falco-playground:ref:refs/tags/*"
  ]
  policies = {
