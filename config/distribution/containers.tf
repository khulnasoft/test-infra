data "http" "falcosidekick_readme" {
  url = "https://raw.githubusercontent.com/khulnasoft/falcosidekick/master/README.md"
}
...
data "http" "falcosidekick_ui_readme" {
  url = "https://raw.githubusercontent.com/khulnasoft/falcosidekick-ui/master/README.md"
}
...
data "http" "falco_readme" {
  url = "https://raw.githubusercontent.com/khulnasoft/falco/master/README.md"
}
...
data "http" "falcoctl_readme" {
  url = "https://raw.githubusercontent.com/khulnasoft/falcoctl/main/README.md"
}
