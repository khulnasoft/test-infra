...
HELM_CHART_NAME="${HELM_CHART_NAME:-"khulnasoft"}"
...
create_pr() {
    ...
    branch="update/khulnasoft-k8s-manifests-${GH_ORG}"
    ...
    body='Updating deployment files (automatically generated by helm template). Made using the [update-khulnasoft-k8s-manifests](https://github.com/khulnasoft/test-infra/blob/main/config/jobs/update-khulnasoft-k8s-manifests/update-khulnasoft-k8s-manifests.yaml) ProwJob. Do not edit this PR.\n\n/kind update\n\n/area manifests'
