...
create_pr() {
    ...
    body=$'Updating maintainers list and the evolution resource files. Made using the [update-maintainers](https://github.com/khulnasoft/test-infra/blob/master/config/jobs/update-maintainers/update-maintainers.yaml) periodic ProwJob. Do not edit this PR.\n\nIn case you wanna change your name or your company change [this file](https://github.com/khulnasoft/evolution/tree/main/people/affiliations.json).\n\n/kind documentation'
